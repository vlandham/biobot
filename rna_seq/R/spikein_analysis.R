...
#gene_name <- "10ng_vs_10_gene_exp.diff"
#gene_name <- "100ng_vs_10_gene_exp.diff"
gene_name <- "10ng_vs_10_2_gene_exp.diff"
gene_file <- paste("spikein_cuffdiff/", gene_name, sep = "")
